...
from legged_gym.envs.go2.go2_config import GO2CfgPPO_Handstand, GO2Cfg_Handstand
from legged_gym.envs.go2.go2_env import Go2_stand
...
task_registry.register( "go2", Go2_stand, GO2Cfg_Handstand(), GO2CfgPPO_Handstand())
