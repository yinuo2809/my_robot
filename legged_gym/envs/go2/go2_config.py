...
class GO2_Jump_Cfg( LeggedRobotCfg ):
    class env:
        #change obs dim
        frame_stack = 10  #action stack
        c_frame_stack = 3 #critic stack
        num_single_obs = 47
        num_observations = int(frame_stack * num_single_obs)  #10帧的观测
        num_single_privileged_obs = 70
...
class GO2JumpCfgPPO( LeggedRobotCfgPPO ):
    seed = 1
