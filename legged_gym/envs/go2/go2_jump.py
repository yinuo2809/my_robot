...
from legged_gym.envs.go2.go2_config import GO2_Jump_Cfg, GO2JumpCfgPPO
...
class GO2_JUMP_Robot(BaseTask):
    def __init__(self, cfg: GO2_Jump_Cfg, sim_params, physics_engine, sim_device, headless):
    ...
    def _process_rigid_body_props(self, props, env_id):
        ...
        if self.cfg.domain_rand.randomize_base_mass:
            self.added_base_masses = torch_rand_float(self.cfg.domain_rand.added_mass_range[0], self.cfg.domain_rand.added_mass_range[1], (1, 1), device=self.device)
    ...
    def _init_buffers(self):
        ...
        #模拟现实世界中的通信延迟，cmd延迟，obs延迟，imu延迟
        ...
        #这里电机的初始化action要乘2是因为后面存数据时，是q和dq一起存进去，也就是要*2
        ...
        #这里的6代表，x/y/z的角速度，以及四元数转化来的row/pitch/yaw
